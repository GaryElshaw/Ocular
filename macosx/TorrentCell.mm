...
- (instancetype)init
{
    if ((self = [super init]))
    {
        ...
        _fTitleAttributes[NSFontAttributeName] = [NSFont messageFontOfSize:13.0];
        ...
        _fStatusAttributes[NSFontAttributeName] = [NSFont messageFontOfSize:12.0];
